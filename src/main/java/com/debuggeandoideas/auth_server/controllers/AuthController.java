package com.debuggeandoideas.auth_server.controllers;

import com.debuggeandoideas.auth_server.dtos.TokenDto;
import com.debuggeandoideas.auth_server.dtos.UserDto;
import com.debuggeandoideas.auth_server.services.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<TokenDto> jwtValidate(@RequestHeader String accessToken){
        return ResponseEntity.ok(this.authService.validateToken(TokenDto.builder().accesToken(accessToken).build()));
    }
}
